...
def build_article(p, cs, cover, cat):
    ...
    return (f'<article class="article">\n'
      ...
      f'  <div class="prose">\n{prose}\n  </div>\n{sim_html}{faq_html}'
      f'  <div class="art-cta">\n'
      f'    <h3>Pronto pra viajar?</h3>\n'
      f'    <p>Monte o roteiro grátis no OND vAI e compre a viagem completa com o OND, agência cadastrada no Cadastur: passagens, hospedagem e passeios num lugar só.</p>\n'
      ...
      f'    </div>\n'
      f'    <p class="art-cta-wpp">Prefere conversar? <a href="https://wa.me/5511910214133" target="_blank" rel="noopener">WhatsApp (11) 91021-4133</a></p>\n'
      f'  </div>\n'
