...
EXTRA_CSS = ('\n.prose ol{margin:0 0 22px 0;padding-left:22px;color:#cfcce8}'
 ...
 '\n.prose .dcard-cta{display:inline-block;margin-top:14px;background:var(--green);color:#0d0d14;font-weight:800;font-size:.9rem;padding:9px 18px;border-radius:999px;text-decoration:none}'
 '\n.prose .dcard-cta:hover{filter:brightness(1.08)}'
 ...
 '\n.prose .dcta-box a{display:inline-block;background:var(--green);color:#0d0d14;font-weight:800;padding:11px 22px;border-radius:999px;text-decoration:none}'
