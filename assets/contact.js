...
(function(){
  ...
  + '.contact-modal-close:hover{border-color:var(--purple,#7f11f4);color:var(--text,#f0eeff)}'
  ...
  + '.contact-option.mail:hover{border-color:var(--purple,#7f11f4)}'
  ...
  + '.contact-option.mail .contact-option-icon{background:var(--purple-dim,rgba(127, 17, 244,.12));border:1px solid color-mix(in srgb, var(--purple,#7f11f4) 20%, transparent)}'
  ...
  +     '<a href="https://wa.me/5511943615412?text=Olá! vim do site OND" class="contact-option wa" target="_blank" rel="noopener">'
  +       '<div class="contact-option-icon">' + wa + '</div>'
  +       '<div><div class="contact-option-label">WhatsApp</div><div class="contact-option-desc">Resposta rápida · (11) 94361-5412</div></div>'
  +       '<div class="contact-option-arrow">→</div></a>'
  +     '<a href="mailto:renan@ondviajar.com.br" class="contact-option mail">'
  +       '<div class="contact-option-icon"><svg class="ico" width="1em" height="1em" style="vertical-align:-.15em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 5L2 7"/></svg></div>'
  +       '<div><div class="contact-option-label">E-mail</div><div class="contact-option-desc">renan@ondviajar.com.br</div></div>'
  +       '<div class="contact-option-arrow">→</div></a>'
  +     '<a href="https://pci.jotform.com/form/252517268656062" class="contact-option form" target="_blank" rel="noopener">'
  +       '<div class="contact-option-icon"><svg class="ico" width="1em" height="1em" style="vertical-align:-.15em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2M9 12h6M9 16h6"/></svg></div>'
