...
(function(){
  ...
  + '#roteiro-sim .gday-ar{color:#7f11f4;transition:transform .25s;font-size:11px;flex:none}#roteiro-sim .gday.open .gday-ar{transform:rotate(180deg)}'
  ...
  + '#roteiro-sim .ga-arrow{align-self:center;color:#7f11f4;font-weight:700;flex:none;font-size:12px}'
  ...
  + '#roteiro-sim .ga-time{font-size:9.5px;color:#7f11f4;font-weight:600;margin-top:3px}#roteiro-sim .ga-star{color:#e8a200;font-weight:700}'
  ...
  + '#roteiro-sim .dt-title{font-weight:700;font-size:12.5px;color:#2a2438;text-align:center;line-height:1.25}#roteiro-sim .dt-meta{font-size:11px;color:#7f11f4;font-weight:700;text-align:center;margin:3px 0 9px}'
  ...
  + '#roteiro-sim .date-banner{background:#7f11f4;color:#fff;font-weight:800;border-radius:12px;padding:12px;text-align:center;margin:0 13px 12px;font-size:12.5px}'
  ...
  + '#roteiro-sim .chk{display:flex;align-items:center;gap:9px;font-size:11.5px;color:#33304a;padding:6px 0}#roteiro-sim .chk input{width:15px;height:15px;accent-color:#7f11f4;flex:none}'
  ...
  + '#roteiro-sim .rgen-star::before{content:"";position:absolute;inset:0;border-radius:50%;border:3px solid #e6dcfb;border-top-color:#7f11f4;animation:rgen-spin .9s linear infinite}'
  ...
  + '#roteiro-sim .rgen-t{font-size:14px;font-weight:800;color:#4e1a9e}#roteiro-sim .rgen-play{background:#7f11f4;color:#fff;border:none;border-radius:22px;padding:11px 20px;font-size:13px;font-weight:800;cursor:pointer;font-family:inherit;box-shadow:0 6px 18px rgba(127, 17, 244,.32)}'
  /* CTA */
  ...
  + '#roteiro-sim .rcta-btn{display:inline-flex;align-items:center;gap:8px;background:#7f11f4;color:#fff;border:none;border-radius:50px;padding:14px 26px;font-size:1rem;font-weight:800;cursor:pointer;font-family:inherit;text-decoration:none;box-shadow:0 6px 24px rgba(127, 17, 244,.4)}'
